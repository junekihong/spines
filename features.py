...
class FeatureMapper(object):
    ...
    def __init__(self, vocabfile, verbose=True):
        ...
        if vocabfile is not None:
            ...
            self.ldict_keys = data['ldict_keys']
    ...
    def from_dict(data):
        ...
        new.ldict_keys = data['ldict_keys']
    ...
    def l_action(self, index):
        if index == 0:
            ...
            return 'label-' + self.ldict_keys[index - 1]
